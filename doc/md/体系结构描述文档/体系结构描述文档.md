...
| messageblservice     |                                          |
| messagebl            | messageblservice, messagedataservice, po, userbl |
...
| clietbl模块提供的服务（供接口）            |      |                                          |
| ------------------------------ | ---- | ---------------------------------------- |
| `ClientBlService.searchClient`   | 语法   | `public ArraytList<ClientVO> searchClient(String searchContext)` |
|                                | 前置条件 | 输入的信息符合输入条件                              |
|                                | 后置条件 | 查找到目标客户                                  |
...
|                                | 前置条件 | 修改的客户信息符合输入条件                            |
|                                | 后置条件 | 删除客户，更新持久化对象                             |
| `ClientInfoBlService.getClient` | 语法   | `public ClientVO getClient(String ID, String name)` |
|                                | 前置条件 | 修改的客户信息符合输入条件                            |
|                                | 后置条件 | 删除客户，更新持久化对象                             |
<br/>
...
|                             | 前置条件 | 同样的po在数据中不存在                             |
|                             | 后置条件 | 增加一条po数据                                 |
| `CLientDataService.find`    | 语法   | `public ClientPO find(ClientPO clientpo) throws RemoteException` |
|                             | 前置条件 | 无                                        |
|                             | 后置条件 | 查找返回相应的结果                                |
...
|                             | 前置条件 | 同样的po在数据中存在                              |
|                             | 后置条件 | 更新一个po                                   |
| `CLientDataService.init`    | 语法   | `public void  init() throws RemoteException` |
|                             | 前置条件 | 无                                        |
|                             | 后置条件 | 初始化持久数据                                  |
<br/>
<br/>
...
|                                          | 前置条件 | 同样的po在数据中不存在                             |
|                                          | 后置条件 | 增加一条po数据                                 |
| `PurchaseTradeBilldataService.find`      | 语法   | `public PurchasePO find(PurchaseTradeBillPO po) throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 查找返回相应的结果                                |
...
|                                          | 前置条件 | 同样的po在数据中存在                              |
|                                          | 后置条件 | 更新po                                     |
| `PurchaseTradeBilldataService.init`      | 语法   | `public ResultMessage init() throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 初始化持久数据                                  |
| `PurchaseTradeBilldataService.getPurchaseTradeBillID` | 语法   | `public String getPurchaseID  () throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 得到进货单ID                                  |
...
|                                          | 前置条件 | 同样的po在数据中存在                              |
|                                          | 后置条件 | 更新po                                     |
| `PurchaseRefundBilldataService.init`     | 语法   | `public ResultMessage init() throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 初始化持久数据                                  |
| `PurchaseRefundBilldataService.getPurchaseTradeBillID` | 语法   | `public String getPurchaseID  () throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 得到进货单ID                                  |
...
|                                          | 前置条件 | 同样的po在数据中不存在                             |
|                                          | 后置条件 | 增加一条po数据                                 |
| `SaleTradeBilldataService.find`          | 语法   | `public SalePO find(SaleTradeBillPO po) throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 查找返回相应的结果                                |
...
|                                          | 前置条件 | 同样的po在数据中存在                              |
|                                          | 后置条件 | 更新po                                     |
| `SaleTradeBilldataService.init`          | 语法   | `public ResultMessage init() throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 初始化持久数据                                  |
| `SaleTradeBilldataService.getSaleTradeBillID` | 语法   | `public String getSaleID  () throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 得到进货单ID                                  |
...
|                                          | 前置条件 | 同样的po在数据中存在                              |
|                                          | 后置条件 | 更新po                                     |
| `SaleRefundBilldataService.init`         | 语法   | `public ResultMessage init() throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 初始化持久数据                                  |
| `SaleRefundBilldataService.getSaleTradeBillID` | 语法   | `public String getSaleID  () throws RemoteException` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 得到进货单ID                                  |
