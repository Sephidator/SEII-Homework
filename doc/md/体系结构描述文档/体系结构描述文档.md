...
| --------------------------- | ---- | ---------------------------------------- |
| `AccountDataService.find`   | 语法   | `public ArrayList<AccountPO> find(AccountQueryPO query) throws RemoteException` |
|                             | 前置条件 | 持久化数据中存在账户                               |
|                             | 后置条件 | 根据账户关键字查找并返回相应的账户列表                      |
| `AccountDataService.getID`  | 语法   | `public String getID() throws RemoteException` |
|                             | 前置条件 | 未达到当日账户上限                                |
|                             | 后置条件 | 返回一个新的账户编号                               |
...
| ------------------------------- | ---- | ---------------------------------------- |
| `PaymentBillDataService.find`   | 语法   | `public ArrayList<PaymentBillPO> find(BillQueryPO query) throws RemoteException` |
|                                 | 前置条件 | 持久化数据中存在查询的付款单                           |
|                                 | 后置条件 | 根据付款单查询条件查找并返回相应的付款单列表                   |
| `PaymentBillDataService.getID`  | 语法   | `public String getID() throws RemoteException` |
|                                 | 前置条件 | 未达到当日付款单上限                               |
|                                 | 后置条件 | 返回新的付款单编号                                |
...
|                                 | 前置条件 | 持久化数据中存在同样ID的po                          |
|                                 | 后置条件 | 更新一个po                                   |
| `ReceiptBillDataService.find`   | 语法   | `public ArrayList<ReceiptBillPO> find(BillQueryPO query) throws RemoteException` |
|                                 | 前置条件 | 持久化数据中存在查询收款单                            |
|                                 | 后置条件 | 根据收款单查询信息查找并返回相应的收款单列表                   |
| `ReceiptBillDataService.getID`  | 语法   | `public String getID() throws RemoteException` |
|                                 | 前置条件 | 未达到当日收款单上限                               |
|                                 | 后置条件 | 返回新的收款单编号                                |
...
|                                 | 前置条件 | 持久化数据中存在同样ID的po                          |
|                                 | 后置条件 | 更新一个po                                   |
| `CashBillDataService.find`      | 语法   | `public ArrayList<CashBillPO> find(BillQueryPO query) throws RemoteException` |
|                                 | 前置条件 | 持久化数据中存在现金费用款单id                         |
|                                 | 后置条件 | 根据现金费用单查询信息查找并返回相应的现金费用单列表               |
| `CashBillDataService.getID`     | 语法   | `public String getID() throws RemoteException` |
|                                 | 前置条件 | 未达到当日现金费用单上限                             |
|                                 | 后置条件 | 返回新的现金费用单编号                              |
...
| --------------------------- | ---- | ---------------------------------------- |
| `InitialDataService.find`   | 语法   | `public ArrayList<InitialPO> find(InitialQueryPO query) throws RemoteException` |
...
| logdata模块提供的服务（供接口）     |      |                                          |
| ----------------------- | ---- | ---------------------------------------- |
| `LogDataService.find`   | 语法   | `public LogPO find(LogQueryPO query) throws RemoteException` |
