...
| `GoodsTool.getGoodsList(GoodsQueryVO query)` | 修改单一持久化对象       |
...
| ---------------------------------------- | ------------------ |
| 服务名                                      | 服务                 |
|`PurchaseTradeBillTool.getPurchaseTradeBillList(PurchaseTradeBillQueryVO query)`| 取得进货单列表|
|`PurchaseRefundBillTool.getPurchaseRefundBillList(PurchaseRefundBillQueryVO query)`| 取得进货退货单列表|
|`SaleTradeBillTool.getSaleTradeBillList(SaleTradeBillQueryVO query)`| 取得销售单列表|
|`SaleRefundBillTool.getSaleRefundBillList(SaleRefundBillQueryVO query)`| 取得进货单列表|
<br/>
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `InventoryLossOverBillBlService/InventoryLossOverBillTool.getInventoryLossOverBillList` | 语法   | `public ArrayList<InventoryLossOverBillVO> getInventoryLossOverBillList(InventoryLossOverBillQueryVO query)` |
|                                         | 前置条件 | 无               |
|                                         | 后置条件 | 取得进货单列表                 |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `InventoryGiftBillBlService/InventoryGiftBillTool.getInventoryGiftBillList` | 语法   | `public ArrayList<InventoryGiftBillVO> getInventoryGiftBillList(InventoryGiftBillQueryVO query)` |
|                                         | 前置条件 | 无               |
|                                         | 后置条件 | 取得进货单列表                 |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `PurchaseTradeBillBlService/PurchaseTradeBillTool.getPurchaseTradeBillList` | 语法   | `public ArrayList<PurchaseTradeBillVO> getPurchaseTradeBillList(PurchaseTradeBillQueryVO query)` |
|                                         | 前置条件 | 无               |
|                                         | 后置条件 | 取得进货单列表                 |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `PurchaseRefundBilllService/PurchaseRefundBillTool.getPurchaseRefudnBillList` | 语法   | `public ArrayList<PurchaseRefundBillVO> getRefundTradeBillList(PurchaseRefundBillQueryVO query)` |
|                                         | 前置条件 | 无                                   |
|                                         | 后置条件 |取得进货退货单列表                  |
...
| `CLientTool.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `InventoryTool.getInventoryList(RepositoryQueryVO query)`       | 取得仓库列表     |
| `GoodsTool.getGoodsList(GoodsQueryVO query)`               | 取得商品列表     |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `ClientTool.editClient(ClientVO client)`| 更改客户信息 |
| `GoodsTool.editGoods(GoodsVO goods)`| 更改在库商品数 |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `SaleTradeBillBlService/SaleTradeBillTool.getSaleTradeBillList` | 语法   | `public ArrayList<SaleTradeBillVO> getSaleTradeBillList(SaleTradeBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得销售单列表              |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
|`SaleRefundBilllService/SaleRefundBillTool.getSaleRefudnBillList` | 语法   | `public ArrayList<SaleRefundBillVO> getRefundTradeBillList(SaleRefundBillQueryVO query)` |
|                                         | 前置条件 | 无                                   |
|                                         | 后置条件 | 取得销售退货单列表        |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `PaymentBillBlService/PaymentBillTool.getPaymentBillList` | 语法   | `public ArrayList<PaymentBillBillVO> getPaymentBillList(PaymentBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得收款单列表                                  |
...
| `ClientTool.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `GoodsTool.getAccountList(AccountQueryVO query)`               | 取得账户列表     |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `ClientTool.editClient(ClientVO client)`| 更改客户信息 |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `ReceiptBillBlService/ReceiptBillTool.getReceiptBillList` | 语法   | `public ArrayList<ReceiptBillBillVO> getReceiptBillList(ReceiptBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得收款单列表                                  |
...
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `CashBillBlService/CashBillTool.getCashBillList` | 语法   | `public ArrayList<CashBillBillVO> getCashBillList(CashBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得现金费用单列表                                  |
...
| `ClientTool.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `GoodsTool.getAccountList(AccountQueryVO query)`               | 取得账户列表     |
| `ClientTool.getGoodsList(GoodsQueryVO query)`             | 取得商品列表     |
...
|                | 前置条件 |无                      |
|                | 后置条件 |                              |
| `LogTool.addLog` | 语法   | `    public ResultMessage addLog(LogVO log)` |
...
| `ReceiptBillTool.pass(ReceiptBillQueryVO query)` | 收款单审批通过 |
| `CashBillTool.pass(CashBillVO vo)` | 现金费用单审批通过 |
| `InventoryLossOverBillTool.pass(InventoryLossOverBillVO vo)` | 库存溢损单审批通过 |
| `InventoryGiftBillTool.pass(InventoryGiftBillQueryVO query)` | 库存赠送单审批通过 |
...
| `ReceiptBillTool.reject(ReceiptBillQueryVO query)` | 收款单审批不通过 |
| `CashBillTool.reject(CashBillVO vo)` | 现金费用单审批不通过 |
| `InventoryLossOverBillTool.reject(InventoryLossOverBillVO vo)` | 库存溢损单审批不通过 |
| `InventoryGiftBillTool.reject(InventoryGiftBillQueryVO query)` | 库存赠送单审批不通过 |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
...
| 提供的服务（供接口）            |      |                                          |
| --------------------- | ---- | ---------------------------------------- |
| `UserBlService/UserTool.getUserList`    | 语法   | `public ArrayList<UserVo> getUserList()` |
|                       | 前置条件 | 正在进行用户管理                                 |
|                       | 后置条件 | 返回用户列表                            |
| `UserBlService.searchUser` | 语法   | `public ArraytList<UserVO> searchUser(String userTool)` |
|                       | 前置条件 | 正在进行用户管理                                 |
|                       | 后置条件 | 根据输入信息返回相应的用户                            |
...
| ---------------------------------------- | ------------------ |
| 服务名                                      | 服务                 |
| `UserDataService.find(String userTool)` | 根据姓名和id进行查找用户|
