...
| `GoodsSortBlService/GoodsSortTool.find` | 语法   | `public GoodsSortVO find(String goodsSortID)` |
|                                         | 前置条件 | 无                                        |
|                                         | 后置条件 | 返回相关的商品分类                                |
...
| 提供的服务（供接口）                             |      |                                          |
| -------------------------------------- | ---- | ---------------------------------------- |
| `GoodsBlService/GoodTool.getGoodsList` | 语法   | `public ArrayList<GoodsVO> getGoodsList(GoodsQueryVO query)` |
|                                        | 前置条件 | 正在进行商品管理                                 |
|                                        | 后置条件 | 返回商品列表                                   |
| `GoodsBlService.addGoods`              | 语法   | `public String addGoods(GoodsVO goods)` |
|                                        | 前置条件 | 正在进行商品管理                                 |
|                                        | 后置条件 | 添加一个商品，更新商品列表                            |
| `GoodsBlService/GoodsTool.editGoods`   | 语法   | `public void editGoods(GoodsVO goods)` |
|                                        | 前置条件 | 正在进行商品管理                                 |
|                                        | 后置条件 | 编辑一个商品，更新商品列表                            |
| `GoodsBlService.deleteGoods`           | 语法   | `public void deleteGoods(String goodsID)` |
|                                        | 前置条件 | 正在进行商品管理                                 |
|                                        | 后置条件 | 删除一个商品，更新商品列表                            |
| `GoodTool.find`                        | 语法   | `public GoodsVO find(String goodsID)` |
|                                        | 前置条件 | 无                                        |
|                                        | 后置条件 | 返回商品                                     |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 取得库存溢损单列表                                |
| `InventoryLossOverBillTool.pass`         | 语法   | `public void pass(BillVO billVO)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 更改库存，修改单据状态                              |
| `InventoryLossOverBillTool.reject`       | 语法   | `public void reject(BillVO billVO)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 修改单据状态为不通过                               |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 取得库存赠送单列表                                |
| `InventoryGiftBillTool.pass`             | 语法   | `public void pass(BillVO billVO)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                   |
| `InventoryGiftBillTool.reject`           | 语法   | `public void reject(BillVO billVO)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 修改单据状态为不通过                               |
...
|                                          | 前置条件 | 开始制定进货单                                  |
|                                          | 后置条件 | 返回客户列表                                   |
| `PurchaseTradeBillBlService.getGoodsList`  | 语法   | `public ArrayList<GoodsVO> getGoodsList(GoodsQueryVO query)` |
|                                          | 前置条件 | 开始制定进货单                                  |
|                                          | 后置条件 | 返回商品列表                                   |
...
|                                          | 前置条件 | 开始制定进货退货单                                |
|                                          | 后置条件 | 返回客户列表                                   |
| `PurchaseRefundBillBlService.getGoodsList` | 语法   | `public ArrayList<GoodsVO> getGoodsList(GoodsQueryVO query)` |
|                                          | 前置条件 | 开始制定进货退货单                                |
|                                          | 后置条件 | 返回商品列表                                   |
...
|                                          | 前置条件 | 制定单据完成                                   |
|                                          | 后置条件 | 更新单据信息                                   |
| `PurchaseRefundBillTool.pass`            | 语法   | `public void pass(BillVO billVO)` |
|                                          | 前置条件 | 单据审批通过                                   |
|                                          | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                   |
| `PurchaseRefundBillTool.reject`          | 语法   | `public void reject(BillVO billVO)` |
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过                               |
...
|                                          | 前置条件 | 开始制定销售单                                  |
|                                          | 后置条件 | 返回客户列表                                   |
| `SaleTradeBillBlService.getGoodsList`      | 语法   | `public ArrayList<goodsVO> getGoodsList(GoodsQueryVO query)` |
|                                          | 前置条件 | 开始制定销售单                                  |
|                                          | 后置条件 | 返回商品列表                                   |
| `SaleTradeBillBlService.getPromotitonList` | 语法   | `public ArrayList<PromotionVO> getPromotionList(PromotionQueryVO query)` |
|                                          | 前置条件 | 开始制定销售单                                  |
|                                          | 后置条件 | 返回符合的促销策略列表                              |
| `SaleTradeBillBlService.submit`         | 语法   | `public String submit(SaleTradeBillVO SaleTradeBillVO)` |
|                                          | 前置条件 | 制定单据完成                                   |
|                                          | 后置条件 | 保存单据，返回单据ID                          |
| `SaleTradeBillBlService.editSaleRefundBill` | 语法   | `public void editSaleRefundBill(SaleTradeBillVO saleTradeBillVO)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 更新单据信息                                   |
| `SaleTradeBillTool.pass`                 | 语法   | `public void pass(BillVO billVO)` |
|                                          | 前置条件 | 单据审批通过                                   |
|                                          | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                   |
| `SaleTradeBillTool.reject`               | 语法   | `public void reject(BillVO billVO)` |
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过                               |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 更新单据信息                                   |
| `SaleRefundBillTool.pass`                | 语法   | `public void pass(BillVO billVO)` |
|                                          | 前置条件 | 单据审批通过                                   |
|                                          | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                   |
| `SaleRefundBillTool.reject`              | 语法   | `public void reject(BillVO billVO)` |
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过                               |
...
|                                          | 前置条件 | 最高权限                                     |
|                                          | 后置条件 | 添加一个账户，更新账户列表                            |
| `AccountBlService/AccountTool.editAccount` | 语法   | `public void editAccount(AccountVO account)` |
|                                          | 前置条件 | 最高权限                                     |
|                                          | 后置条件 | 编辑一个账户，更新账户列表                            |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 返回账户列表                                   |
| `PaymentBillBlService/PaymentBillTool.submit` | 语法   | `public String submit(PaymentBillVO vo)` |
|                                          | 前置条件 | 付款单填写完毕                                  |
...
| `PaymentBillTool.pass`                   | 语法   | `public void pass(BillVO bill) ` |
|                                          | 前置条件 | 单据审批通过                                   |
|                                          | 后置条件 | 更新客户应收信息，更改账户信息，修改单据状态，发送通过消息            |
| `PaymentBillTool.reject`                 | 语法   | `public void reject(BillVO bill) ` |
|                                          | 前置条件 | 单据审批不通过                                  |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 返回账户列表                                   |
| `ReceiptBillBlService/ReceiptBillTool.submit` | 语法   | `public String submit(ReceiptBillVO vo)` |
|                                          | 前置条件 | 收款单填写完毕                                  |
...
| `ReceiptBillTool.pass`                   | 语法   | `public void pass(BillVO bill) ` |
|                                          | 前置条件 | 单据审批通过                                   |
|                                          | 后置条件 | 更新客户应收信息，更改账户信息，修改单据状态，发送通过消息            |
| `ReceiptBillTool.reject`                 | 语法   | `public void reject(BillVO bill) ` |
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过，持久化更新涉及的对象的数据，发送拒绝消息          |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 返回账户列表                                   |
| `CashBillBlService/CashBillTool.submit`  | 语法   | `public String submit(CashBillVO vo)` |
|                                          | 前置条件 | 现金费用单填写完毕                                |
...
| `CashBillTool.pass`    | 语法   | `public void pass(BillVO bill) ` |
|                                          | 前置条件 | 单据审批通过                                   |
|                                          | 后置条件 | 更新客户应收信息，更改账户信息，修改单据状态，发送通过消息            |
| `CashBillTool.reject`  | 语法   | `public void reject(BillVO bill) ` |
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过，持久化更新涉及的对象的数据，发送拒绝消息          |
...
|                               | 前置条件 | 无                                        |
|                               | 后置条件 | 获取查询的日志列表                                |
| `LogBlService/LogTool.addLog` | 语法   | `public void addLog(LogVO log)` |
...
| `PurchseRefundBillTool.getPurchseRefundBillList(BillQueryVO query)` | 返回进货退货单列表 |
...
| `InventoryLossOverBillTool.getInventoryLossOverBillList(BillQueryVO query)` | 返回库存溢损单列表  |
| `InventoryGiftBillTool.getInventoryGiftBillList(BillQueryVO query)` | 返回库存赠送单列表  |
| `PurchaseTradeBillTool.pass(BillVO billVO)` | 进货单审批通过    |
| `PurchseRefundBillTool.pass(BillVO billVO)` | 进货退货单审批通过  |
| `SaleTradeBillTool.pass(BillVO billVO)` | 销售单审批通过    |
| `SaleRefundBillTool.pass(BillVO billVO)` | 销售退货单审批通过  |
| `PaymentBillTool.pass(BillVO bill)` | 付款单审批通过    |
| `ReceiptBillTool.pass(BillVO bill)` | 收款单审批通过    |
| `CashBillTool.pass(BillVO bill)` | 现金费用单审批通过  |
| `InventoryLossOverBillTool.pass(BillVO billVO)` | 库存溢损单审批通过  |
| `InventoryGiftBillTool.pass(BillVO billVO)` | 库存赠送单审批通过  |
| `PurchaseTradeBillTool.reject(BillVO billVO)` | 进货单审批不通过   |
| `PurchseRefundBillTool.reject(BillVO billVO)` | 进货退货单审批不通过 |
| `SaleTradeBillTool.reject(BillVO billVO` | 销售单审批不通过   |
| `SaleRefundBillTool.reject(BillVO billVO)` | 销售退货单审批不通过 |
| `PaymentBillTool.reject(BillVO bill)` | 付款单审批不通过   |
| `ReceiptBillTool.reject(BillVO bill)` | 收款单审批不通过   |
| `CashBillTool.reject(BillVO bill)` | 现金费用单审批不通过 |
| `InventoryLossOverBillTool.reject(BillVO billVO)` | 库存溢损单审批不通过 |
| `InventoryGiftBillTool.reject(BillVO billVO)` | 库存赠送单审批不通过 |
| `LogTool.addLog(LogVO log)` | 记录日志       |
...
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 无                                        |
| `PromotionTool.getPromotionList`         | 语法   | `public ArrayList<PromotionVO> getPromotionList(PromotionQueryVO query)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 系统显示符合条件的促销策略                            |
| `PromotionTool.find`                     | 语法   | `public PromotionVO find(String promotionID)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 系统显示符合条件的促销策略                            |
...
|                                      | 前置条件 | 正在进行用户管理                                 |
|                                      | 后置条件 | 删除一个用户，更新用户列表                            |
| `UserTool.find`                      | 语法   | `public UserVO find(String userID)` |
|                                      | 前置条件 | 无                                        |
|                                      | 后置条件 | 插入单一持久化对象                                |
| `UserTool.login`                     | 语法   | `public UserVO login(String jobName, String password)` |
|                                      | 前置条件 | 无                                        |
|                                      | 后置条件 | 用户更改为已登录状态                               |
| `UserTool.logout`                    | 语法   | `public void logout(String userID)` |
|                                      | 前置条件 | 无                                        |
|                                      | 后置条件 | 用户退出登录                                   |
...
| ------------------------------------- | ---- | ---------------------------------------- |
| 服务名                                   | 服务   |                                          |
| `InventoryGiftBillDataService.finds`  | 语法   | `public ArrayList<InventoryGiftBillPO> finds(BillQueryPO query)` |
|                                       | 前置条件 | 无                                        |
|                                       | 后置条件 | 取得赠送单列表                                  |
...
|                          | 前置条件 | 无                                        |
|                          | 后置条件 | 返回根据ID查找到的唯一帐号                           |
| `UserDataService.finds`  | 语法   | `public ArrayList<UserPO> find(UserQueryVO query)` |
|                          | 前置条件 | 无                                        |
|                          | 后置条件 | 返回符合筛选条件的帐号                              |
