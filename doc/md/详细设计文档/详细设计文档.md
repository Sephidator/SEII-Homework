...
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过                               |
| `PaymentBillBlService/PaymentBillTool.getPaymentBillList` | 语法   | `public ArrayList<PaymentBillVO> getPaymentBillList(PaymentBillQueryVO query)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 取得收款单列表                                  |
...
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过                               |
| `ReceiptBillBlService/ReceiptBillTool.getReceiptBillList` | 语法   | `public ArrayList<ReceiptBillVO> getReceiptBillList(ReceiptBillQueryVO query)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 取得收款单列表                                  |
...
|                                          | 前置条件 | 单据审批不通过                                  |
|                                          | 后置条件 | 修改单据状态为不通过                               |
| `CashBillBlService/CashBillTool.getCashBillList` | 语法   | `public ArrayList<CashBillVO> getCashBillList(CashBillQueryVO query)` |
|                                          | 前置条件 | 无                                        |
|                                          | 后置条件 | 取得现金费用单列表                                |
...
| reportbl模块的类               | 职责               |
| -------------------------- | ---------------- |
| SaleDetailBlService        | 负责实现构造销售明细表所需的服务 |
| BusinessHistoryBlService   | 负责实现构造经营历程表所需的服务 |
| BusinessConditionBlService | 负责实现构造经营情况表所需的服务 |
...
| `PurchaseRefundBillTool.getPurchaseRefundBillList(PurchaseRefundBillQueryVO query)` | 返回进货退货单列表 |
| `SaleTradeBillTool.getSaleTradeBillList(SaleTradeBillQueryVO query)` | 返回销售单列表   |
| `SaleRefundBillTool.getSaleRefundBillList(SaleRefundBillQueryVO query)` | 返回销售退货单列表 |
...
| approvalbl模块的类    | 职责           |
| ----------------- | ------------ |
| ApprovalBlService | 负责审批单据的所需的业务 |
...
| promotionbl模块的类    | 职责               |
| ------------------ | ---------------- |
| PromotionBlService | 负责实现促销策略管理所需要的服务 |
| PromotionTool      | 提供层内有关促销策略服务     |
...
| ---------------------------------------- | ------------ |
| 服务名                                      | 服务           |
| `PromotionDataService.find(PromotionQueryPO quert)` | 根据筛选条件查找促销策略 |
...
| ---------------------------------------- | --------- |
| 服务名                                      | 服务        |
| `UserDataService.find()`                 | 取得所有用户的列表 |
