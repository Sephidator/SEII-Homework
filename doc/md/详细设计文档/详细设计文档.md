...
| 提供的服务（供接口）                  |      |                                          |
| --------------------------- | ---- | ---------------------------------------- |
| `GoodsSortBlService.getGoodsSortList` | 语法   | `public ArraytList<GoodsSortVO> searchGoodsSort(GoodsSortQueryVO query)` |
|                             | 前置条件 | 正在进行商品分类管理                               |
|                             | 后置条件 | 根据输入信息返回相应的商品分类                          |
| `GoodsSortBlService.addGoodsSort` | 语法   | `public ResultMessage insertGoodsSort(GoodsSortVO goodsSort)` |
|                             | 前置条件 | 正在进行商品分类管理                               |
...
| `GoodsSortBlService.editGoodsSort` | 语法   | `public ResultMessage updateGoodsSort(GoodsSortVO goodsSort)` |
|                             | 前置条件 | 正在进行商品分类管理                               |
|                             | 后置条件 | 编辑一个商品分类，更新商品分类列表                        |
| `GoodsSortBlService.getID`           | 语法   | `public String getID(String fatherSort)` |
|                             | 前置条件 | 商品分类已添加                                  |
|                             | 后置条件 | 返回新商品分类ID                                |
...
| `GoodsInfo.getGoodsList(GoodsQueryVO query)` | 修改单一持久化对象       |
...
| 提供的服务（供接口）            |      |                                          |
| --------------------- | ---- | ---------------------------------------- |
| `GoodsBlService/GoodsInfo.getGoodsList`    | 语法   | `public ArrayList<GoodsVo> getGoodsList(GoodsQueryVO query)` |
|                       | 前置条件 | 正在进行商品管理                                 |
|                       | 后置条件 | 返回商品列表                            |
| `GoodsBlService.addGoods`    | 语法   | `public ResultMessage addGoods(GoodsVO goods)` |
|                       | 前置条件 | 正在进行商品管理                                 |
|                       | 后置条件 | 添加一个商品，更新商品列表                            |
| `GoodsBlService/GoodsOperate.editGoods`   | 语法   | `public ResultMessage editGoods(GoodsVO goods)` |
|                       | 前置条件 | 正在进行商品管理                                 |
|                       | 后置条件 | 编辑一个商品，更新商品列表                            |
...
| ---------------------------------------- | ------------------ |
| 服务名                                      | 服务                 |
|`PurchaseTradeBillInfo.getPurchaseTradeBillList(PurchaseTradeBillQueryVO query)`| 取得进货单列表|
|`PurchaseRefundBillInfo.getPurchaseRefundBillList(PurchaseRefundBillQueryVO query)`| 取得进货退货单列表|
|`SaleTradeBillInfo.getSaleTradeBillList(SaleTradeBillQueryVO query)`| 取得销售单列表|
|`SaleRefundBillInfo.getSaleRefundBillList(SaleRefundBillQueryVO query)`| 取得进货单列表|
<br/>
...
| ---------------------------------------- | ---------------- |
| 服务名                                      | 服务               |
| `GoodsInfo.getGoodsList(GoodsQueryVO query)` | 取得商品列表       |
...
|                                         | 前置条件 | 制定单据完成                                   |
|                                         | 后置条件 | 保存单据草稿                                  |
| `InventoryLossOverBillOperate.pass` | 语法   | `public ResultMessage pass(InventoryLossOverBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                                  |
| `InventoryLossOverBillOperate.reject` | 语法   | `public ResultMessage reject(InventoryLossOverBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `InventoryLossOverBillBlService/InventoryLossOverBillInfo.getInventoryLossOverBillList` | 语法   | `public ArrayList<InventoryLossOverBillVO> getInventoryLossOverBillList(InventoryLossOverBillQueryVO query)` |
|                                         | 前置条件 | 无               |
|                                         | 后置条件 | 取得进货单列表                 |
...
| `GoodsOperate.editGoods(GoodsVO goods)`               | 取得商品列表     |
...
|                                         | 前置条件 | 制定单据完成                                   |
|                                         | 后置条件 | 保存单据草稿                                  |
| `InventoryLossOverBillOperate.pass` | 语法   | `public ResultMessage pass(InventoryGiftBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                                  |
| `InventoryLossOverBillOperate.reject` | 语法   | `public ResultMessage reject(InventoryGiftBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `InventoryGiftBillBlService/InventoryGiftBillInfo.getInventoryGiftBillList` | 语法   | `public ArrayList<InventoryGiftBillVO> getInventoryGiftBillList(InventoryGiftBillQueryVO query)` |
|                                         | 前置条件 | 无               |
|                                         | 后置条件 | 取得进货单列表                 |
...
| 提供的服务（供接口）            |      |                                          |
| --------------------- | ---- | ---------------------------------------- |
| `ClientBlService/ClientInfo.getClientList`    | 语法   | `public ArrayList<ClientVo> getClientList(ClientQueryVO query)` |
|                       | 前置条件 | 正在进行客户管理                                 |
|                       | 后置条件 | 返回客户列表                            |
| `ClientBlService.addClient`    | 语法   | `public ResultMessage addClient(ClientVO client)` |
|                       | 前置条件 | 正在进行客户管理                                 |
|                       | 后置条件 | 添加一个客户，更新客户列表                            |
| `ClientBlService/ClientOperate.editClient`   | 语法   | `public ResultMessage editClient(ClientVO client)` |
|                       | 前置条件 | 正在进行客户管理                                 |
|                       | 后置条件 | 编辑一个客户，更新客户列表                            |
...
| `ClientDataService.getClientID()`    | 得到新的客户ID           |
...
|                                         | 前置条件 | 开始制定进货单                                  |
|                                         | 后置条件 | 返回客户列表                                   |
| `PurchaseTradeBillBlService.getRepositoryList`   | 语法   | `public ArrayList<ClientVO> getRepositoryList(RepositoryQueryVO query)` |
|                                         | 前置条件 | 开始制定进货单                                  |
|                                         | 后置条件 | 返回仓库列表                                   |
| `PurchaseTradeBillService.getGoodsList`        | 语法   | `public ArrayList<ClientVO> getGoodsList(GoodsQueryVO query)` |
|                                         | 前置条件 | 开始制定进货单                                  |
|                                         | 后置条件 | 返回商品列表                                   |
...
|                                         | 前置条件 | 制定单据完成                                   |
|                                         | 后置条件 | 保存单据草稿                                  |
| `PurchaseTradeBillOperate.pass` | 语法   | `public ResultMessage pass(PurchaseTradeBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                                  |
| `PurchaseTradeBillOperate.reject` | 语法   | `public ResultMessage reject(PurchaseTradeBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `PurchaseTradeBillBlService/PurchaseTradeBillInfo.getPurchaseTradeBillList` | 语法   | `public ArrayList<PurchaseTradeBillVO> getPurchaseTradeBillList(PurchaseTradeBillQueryVO query)` |
|                                         | 前置条件 | 无               |
|                                         | 后置条件 | 取得进货单列表                 |
...
| ---------------------------------------- | ---------- |
| 服务名                                      | 服务         |
| `PurchaseTradeBillDataService.find(PurchaseTradeBillQueryPO query)` | 取得进货单列表 |
| `PurchaseTradeBillDataService.getID()`   | 得到新的进货单ID  |
| `PurchaseTradeBillDataService.insert(PurchaseTradeBillPO po)` | 添加进货单  |
| `PurchaseTradeBillDataService.update(PurchaseTradeBillPO po)` | 添加进货单  |
| `ClientInfo.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `GoodsInfo.getGoodsList(GoodsQueryVO query)`               | 取得商品列表     |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `ClientOperate.editClient(ClientVO client)`| 更改客户信息 |
| `GoodsOperate.editGoods(GoodsVO goods)`| 更改在库商品数 |
...
|                                         | 前置条件 | 开始制定进货退货单                                  |
|                                         | 后置条件 | 返回客户列表                                   |
| `PurchaseRefundBillBlService.getRepositoryList`   | 语法   | `public ArrayList<ClientVO> getRepositoryList(RepositoryQueryVO query)` |
|                                         | 前置条件 | 开始制定进货退货单                                  |
|                                         | 后置条件 | 返回仓库列表                                   |
| `PurchaseRefundBillService.getGoodsList`        | 语法   | `public ArrayList<ClientVO> getGoodsList(GoodsQueryVO query)` |
|                                         | 前置条件 | 开始制定进货退货单                                  |
|                                         | 后置条件 | 返回商品列表                                   |
...
|                                         | 前置条件 | 制定单据完成                                   |
|                                         | 后置条件 | 保存单据草稿                                  |
| `PurchaseRefundBillOperate.pass` | 语法   | `public ResultMessage pass(PurchaseRefundBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                                  |
| `PurchaseRefundBillOperate.reject` | 语法   | `public ResultMessage reject(PurchaseRefundBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `PurchaseRefundBilllService/PurchaseRefundBillInfo.getPurchaseRefudnBillList` | 语法   | `public ArrayList<PurchaseRefundBillVO> getRefundTradeBillList(PurchaseRefundBillQueryVO query)` |
|                                         | 前置条件 | 无                                   |
|                                         | 后置条件 |取得进货退货单列表                  |
...
| ---------------------------------------- | ---------- |
| 服务名                                      | 服务         |
| `PurchaseRefundBillDataService.find(PurchaseRefundBillQueryPO query)` | 取得进货单列表 |
...
| `CLientInfo.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `InventoryInfo.getInventoryList(RepositoryQueryVO query)`       | 取得仓库列表     |
| `GoodsInfo.getGoodsList(GoodsQueryVO query)`               | 取得商品列表     |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `ClientOperate.editClient(ClientVO client)`| 更改客户信息 |
| `GoodsOperate.editGoods(GoodsVO goods)`| 更改在库商品数 |
...
|                                         | 前置条件 | 开始制定销售单                                  |
|                                         | 后置条件 | 返回客户列表                                   |
| `SaleTradeBillBlService.getRepositoryList`   | 语法   | `public ArrayList<ClientVO> getRepositoryList(RepositoryQueryVO query)` |
|                                         | 前置条件 | 开始制定销售单                                  |
|                                         | 后置条件 | 返回仓库列表                                   |
| `SaleTradeBillService.getGoodsList`        | 语法   | `public ArrayList<ClientVO> getGoodsList(GoodsQueryVO query)` |
|                                         | 前置条件 | 开始制定销售单                                  |
|                                         | 后置条件 | 返回商品列表                                   |
...
|                                         | 前置条件 | 制定单据完成                                   |
|                                         | 后置条件 | 保存单据草稿                                  |
| `SaleTradeBillOperate.pass` | 语法   | `public ResultMessage pass(SaleTradeBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                                  |
| `SaleTradeBillOperate.reject` | 语法   | `public ResultMessage reject(SaleTradeBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `SaleTradeBillBlService/SaleTradeBillInfo.getSaleTradeBillList` | 语法   | `public ArrayList<SaleTradeBillVO> getSaleTradeBillList(SaleTradeBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得销售单列表              |
...
| ---------------------------------------- | ---------- |
| 服务名                                      | 服务         |
| `SaleTradeBillDataService.find(SaleTradeBillQueryPO query)` | 取得销售单列表 |
...
| `InventoryInfo.getInventoryList(RepositoryQueryVO query)`       | 取得仓库列表     |
| `GoodsInfo.getGoodsList(GoodsQueryVO query)`               | 取得商品列表     |
| `PromotionInfo.getPromotionList(PromotionQueryVO query)`       | 取得促销策略列表   |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `ClientOperate.editClient(ClientVO client)`| 更改客户信息 |
| `GoodsOperate.editGoods(GoodsVO goods)`| 更改在库商品数 |
...
|                                         | 前置条件 | 开始制定销售退货单                                  |
|                                         | 后置条件 | 返回客户列表                                   |
| `SaleRefundBillBlService.getRepositoryList`   | 语法   | `public ArrayList<ClientVO> getRepositoryList(RepositoryQueryVO query)` |
|                                         | 前置条件 | 开始制定销售退货单                                  |
|                                         | 后置条件 | 返回仓库列表                                   |
| `SaleRefundBillService.getGoodsList`        | 语法   | `public ArrayList<ClientVO> getGoodsList(GoodsQueryVO query)` |
|                                         | 前置条件 | 开始制定销售退货单                                  |
|                                         | 后置条件 | 返回商品列表                                   |
...
|                                         | 前置条件 | 制定单据完成                                   |
|                                         | 后置条件 | 保存单据草稿                                  |
| `SaleRefundBillOperate.pass` | 语法   | `public ResultMessage pass(SaleRefundBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改库存，修改单据状态                                  |
| `SaleRefundBillOperate.reject` | 语法   | `public ResultMessage reject(SaleRefundBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
|`SaleRefundBilllService/SaleRefundBillInfo.getSaleRefudnBillList` | 语法   | `public ArrayList<SaleRefundBillVO> getRefundTradeBillList(SaleRefundBillQueryVO query)` |
|                                         | 前置条件 | 无                                   |
|                                         | 后置条件 | 取得销售退货单列表        |
...
| ---------------------------------------- | ---------- |
| 服务名                                      | 服务         |
| `SaleRefundBillDataService.find(SaleRefundBillQueryPO query)` | 取得销售单列表 |
...
| 提供的服务（供接口）                |      |                                          |
| ------------------------- | ---- | ---------------------------------------- |
| `AccountBlService/AccountInfo.getAccountList`    | 语法   | `public ArrayList<AccountVo> getAccountList(AccountQueryVO query)` |
|                       | 前置条件 | 正在进行账户管理                                 |
|                       | 后置条件 | 返回账户列表                            |
| `AccountBlService.addAccount`    | 语法   | `public ResultMessage addAccount(AccountVO account)` |
|                       | 前置条件 | 正在进行账户管理                                 |
|                       | 后置条件 | 添加一个账户，更新账户列表                            |
| `AccountBlService/AccountOperate.editAccount`   | 语法   | `public ResultMessage editAccount(AccountVO account)` |
|                       | 前置条件 | 正在进行账户管理                                 |
|                       | 后置条件 | 编辑一个账户，更新账户列表                            |
...
#### (2) 整体结构
根据体系结构的设计，我们将系统分为展示层、业务逻辑层、数据层。每一层之间为了增加灵活性，我们会添加接口。此包实现了financeblservice包内的所有接口，并通过financedataservice和data层进行交互。PaymentBillPO、ReceiptBillPO、CashBillPO是作为财务类单据的持久化对象被添加到设计模型中去的。
...
|                                     | 前置条件 | 制定单据完成  |
|                                     | 后置条件 | 保存单据草稿            |
| `PaymentBillOperate.pass` | 语法   | `public ResultMessage pass(PaymentBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改账户信息，修改单据状态         |
| `PaymentBillOperate.reject` | 语法   | `public ResultMessage reject(PaymentBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `PaymentBillBlService/PaymentBillInfo.getPaymentBillList` | 语法   | `public ArrayList<PaymentBillBillVO> getPaymentBillList(PaymentBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得收款单列表                                  |
...
| ---------------------------------------- | ------------------------ |
| 服务名                                      | 服务                       |
| `PaymentBillDataService.find(PaymentBillQueryPO query)`       | 根据筛选条件获取付款单列表  |
...
| `ClientInfo.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `GoodsInfo.getAccountList(AccountQueryVO query)`               | 取得账户列表     |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `ClientOperate.editClient(ClientVO client)`| 更改客户信息 |
| `AccountOperate.editAccount(AccountVO account)`| 更改账户信息 |
...
|                                     | 前置条件 | 制定单据完成                                 |
|                                     | 后置条件 | 保存单据草稿                |
| `ReceiptBillOperate.pass` | 语法   | `public ResultMessage pass(ReceiptBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新客户应收应付信息，更改账户信息，修改单据状态         |
| `ReceiptBillOperate.reject` | 语法   | `public ResultMessage reject(ReceiptBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `ReceiptBillBlService/ReceiptBillInfo.getReceiptBillList` | 语法   | `public ArrayList<ReceiptBillBillVO> getReceiptBillList(ReceiptBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得收款单列表                                  |
...
| ---------------------------------------- | ------------------------ |
| 服务名                                      | 服务                       |
| `ReceiptBillDataService.find(ReceiptBillQueryPO query)`       | 根据筛选条件获取收款单列表  |
...
|                                     | 前置条件 | 当日单据小于99999条                      |
|                                     | 后置条件 | 返回新的现金费用单单据编号                              |
| `CashBillBlService.getClientList`           | 语法   | `  public ArrayList<ClientVO> getClientList(ClientQueryVO query)`          |
|                                     | 前置条件 | 编辑现金费用单时     |
|                                     | 后置条件 | 返回操作员                                    |
...
|                                     | 前置条件 | 制定单据完成                                |
|                                     | 后置条件 | 保存单据草稿                 |
| `CashBillOperate.pass` | 语法   | `public ResultMessage pass(CashBillVO bill)` |
|                                         | 前置条件 | 单据审批通过                                   |
|                                         | 后置条件 | 更新更改账户信息，修改单据状态         |
| `CashBillOperate.reject` | 语法   | `public ResultMessage reject(CashBillVO bill)` |
|                                         | 前置条件 | 单据审批不通过                                   |
|                                         | 后置条件 | 修改单据状态为不通过                                  |
| `CashBillBlService/CashBillInfo.getCashBillList` | 语法   | `public ArrayList<CashBillBillVO> getCashBillList(CashBillQueryVO query)` |
|                                         | 前置条件 | 无                                  |
|                                         | 后置条件 | 取得现金费用单列表                                  |
...
| ---------------------------------------- | ------------------------ |
| 服务名                                      | 服务                       |
| `CashBillDataService.find(CashBillQueryPO query)`       | 根据筛选条件获取现金费用单列表 |
...
#### (2) 整体结构
根据体系结构的设计，我们将系统分为展示层、业务逻辑层、数据层。每一层之间为了增加灵活性，我们会添加接口。此包实现了initialblservice的所有方法，并通过initialdataservice与数据层交互。InitialPO是作为帐户的持久化对象被添加到设计模型中去的。
...
|                              | 前置条件 | 无                                  |
|                              | 后置条件 | 返回上一年的持久化客户对象                            |
| `InitialBlService.getAccountList` | 语法   | `    public ArrayList<AccountPO> getAccountList(AccountQueryVO query)` |
|                              | 前置条件 | 输入的时间合法                                  |
|                              | 后置条件 | 返回上一年的持久化账户对象                            |
...
| `InitialDataService.find(InitialQueryVO query)`           | 获取持久化对象列表            |
| `ClientInfo.getClientList(ClientQueryVO query)`             | 取得客户列表     |
| `GoodsInfo.getAccountList(AccountQueryVO query)`               | 取得账户列表     |
| `ClientInfo.getGoodsList(GoodsQueryVO query)`             | 取得商品列表     |
...
#### (2) 整体结构
根据体系结构的设计，我们将系统分为展示层、业务逻辑层、数据层。每一层之间为了增加灵活性，我们会添加接口。比如展示层和业务逻辑层之间，我们添加logblservice.LogBlService接口。业务逻辑层和数据层之间添加logdataservice.LogDataService接口。LogPO是作为帐户的持久化对象被添加到设计模型中去的。
...
|                | 前置条件 |无                      |
|                | 后置条件 |                              |
| `LogOperate.addLog` | 语法   | `    public ResultMessage addLog(LogVO log)` |
...
| ---------------------------------------- | --------------- |
| 服务名                                      | 服务              |
| `SaleTradeBillInfo.getSaleTradeBillList(SaleTradeBillQueryVO query)` | 返回销售单列表 |
...
| 提供的服务（供接口）                 |      |                                          |
| -------------------------- | ---- | ---------------------------------------- |
| `BusinessHistoryBlService.getBillList`   | 语法   | `public ArrayList<BillVO> getBillList(BusinessHistoryQuaryVO query)` |
|                            | 前置条件 | 无                |
...
| ---------------------------------------- | --------------- |
| 服务名                                      | 服务              |
| `PurchaseTradeBillInfo.getPurchaseTradeBillList(PurchaseTradeBillQueryVO query)` | 返回进货单列表 |
| `PurchseRefundBillInfo.getPurchseRefundBillList(PurchaseRefundBillQueryVO query)` | 返回进货退货单列表 |
| `SaleTradeBillInfo.getSaleTradeBillList(SaleTradeBillQueryVO query)` | 返回销售单列表 |
| `SaleRefundBillInfo.getSaleRefundBilList(SaleRefundBillQueryVO query)` | 返回销售退货单列表 |
| `PaymentBillInfo.getPaymentBillList(PaymentBillQueryVO query)` | 返回付款单列表 |
| `ReceiptBillInfo.getReceiptBillList(ReceiptBillQueryVO query)` | 返回收款单列表 |
| `CashBillInfo.getCashBillList(CashBillQueryVO query)` | 返回现金费用单列表 |
| `InventoryLossOverBillInfo.getInventoryLossOverBillList(InventoryLossOverBillQueryVO query)` | 返回库存溢损单列表 |
| `InventoryGiftBillInfo.getInventoryGiftBillList(InventoryGiftBillQueryVO query)` | 返回库存赠送单列表 |
...
| 提供的服务（供接口）                 |      |                                          |
| -------------------------- | ---- | ---------------------------------------- |
| `BusinessConditionBlService.getSaleIncome`   | 语法   | `public double getSaleIncome(BusinessConditionQueryVO query)` |
|                            | 前置条件 |  如果筛选条件是时间区间             |
|                            | 后置条件 | 系统返回符合筛选条件的销售类收入                          |
| `BusinessConditionBlService.getGoodsIncome`   | 语法   | `public double getGoodsIncome(BusinessConditionQueryVO query)` |
|                            | 前置条件 |  如果筛选条件是时间区间             |
|                            | 后置条件 | 系统返回符合筛选条件的商品类收入                          |
| `BusinessConditionBlService.getDiscount`   | 语法   | `public double getDiscount(BusinessConditionQueryVO query)` |
|                            | 前置条件 |  如果筛选条件是时间区间             |
|                            | 后置条件 | 系统返回符合筛选条件的折让金额                          |
| `BusinessConditionBlService.getSaleCost`   | 语法   | `public double getSaleCost(BusinessConditionQueryVO query)` |
|                            | 前置条件 |  如果筛选条件是时间区间             |
|                            | 后置条件 | 系统返回符合筛选条件的进货类支出                          |
| `BusinessConditionBlService.getGoodsExpenditure`   | 语法   | `public double getGoodsExpenditure(BusinessConditionQueryVO query)` |
|                            | 前置条件 |  如果筛选条件是时间区间             |
|                            | 后置条件 | 系统返回符合筛选条件的商品类支出                          |
...
| 提供的服务（供接口）            |      |                                          |
| --------------------- | ---- | ---------------------------------------- |
| `Approval.getBillList`     | 语法   | `public ArrayList<BillVO> getBillList(BillQueryVO query)` |
|                       | 前置条件 | 无                                        |
|                       | 后置条件 | 系统显示该类型的提交单据                             |
...
| `CashBillInfo.getCashBillList(CashBillQueryVO query)` | 返回现金费用单列表 |
| `InventoryGiftBillInfo.getInventoryGiftBillList(InventoryGiftBillQueryVO query)` | 返回库存赠送单列表 |
| `PurchaseTradeBillOperate.pass(PurchaseTradeBillVO vo)` | 进货单审批通过 |
| `PurchseRefundBillOperate.pass(PurchaseRefundBillVO vo)` | 进货退货单审批通过 |
| `SaleTradeBillOperate.pass(SaleTradeBillVO vo)` | 销售单审批通过 |
| `SaleRefundBillOperate.pass(SaleRefundBillVO vo)` | 销售退货单审批通过 |
| `PaymentBillOperate.pass(PaymentBillVO vo)` | 付款单审批通过 |
| `ReceiptBillOperate.pass(ReceiptBillQueryVO query)` | 收款单审批通过 |
| `CashBillOperate.pass(CashBillVO vo)` | 现金费用单审批通过 |
| `InventoryLossOverBillOperate.pass(InventoryLossOverBillVO vo)` | 库存溢损单审批通过 |
| `InventoryGiftBillOperate.pass(InventoryGiftBillQueryVO query)` | 库存赠送单审批通过 |
| `PurchaseTradeBillOperate.reject(PurchaseTradeBillVO vo)` | 进货单审批不通过 |
| `PurchseRefundBillOperate.reject(PurchaseRefundBillVO vo)` | 进货退货单审批不通过 |
| `SaleTradeBillOperate.reject(SaleTradeBillVO vo)` | 销售单审批不通过 |
| `SaleRefundBillOperate.reject(SaleRefundBillVO vo)` | 销售退货单审批不通过 |
| `PaymentBillOperate.reject(PaymentBillVO vo)` | 付款单审批不通过 |
| `ReceiptBillOperate.reject(ReceiptBillQueryVO query)` | 收款单审批不通过 |
| `CashBillOperate.reject(CashBillVO vo)` | 现金费用单审批不通过 |
| `InventoryLossOverBillOperate.reject(InventoryLossOverBillVO vo)` | 库存溢损单审批不通过 |
| `InventoryGiftBillOperate.reject(InventoryGiftBillQueryVO query)` | 库存赠送单审批不通过 |
| `LogPoerate.addLog(LogVO log)`| 记录日志 |
| `MessageOperate.addMessage(MessageVO message)`|添加系统信息|
...
| 提供的服务（供接口）           |      |                                          |
| -------------------- | ---- | ---------------------------------------- |
| `PromotionBlService/PromotionInfo.getPromotionList`     | 语法   | `public ArrayList<PromotionVO> getPromotionList(PromotionQueryVO query)`   |
|                      | 前置条件 | 无                                        |
|                      | 后置条件 | 系统显示所有促销策略                               |
...
| ---------------------------------------- | ------------- |
| 服务名                                      | 服务            |
| `PromotionDataService.find(PromotionQueryPO quert)(表示promotiondataservice包内全部接口的find方法)` | 根据筛选条件查找促销策略 |
| `PromotionDataService.insert(PromotionPO po)(表示promotiondataservic` | 插入单一持久化对象|
...
| 提供的服务（供接口）            |      |                                          |
| --------------------- | ---- | ---------------------------------------- |
| `UserBlService/UserInfo.getUserList`    | 语法   | `public ArrayList<UserVo> getUserList()` |
|                       | 前置条件 | 正在进行用户管理                                 |
|                       | 后置条件 | 返回用户列表                            |
| `UserBlService.searchUser` | 语法   | `public ArraytList<UserVO> searchUser(String userInfo)` |
|                       | 前置条件 | 正在进行用户管理                                 |
|                       | 后置条件 | 根据输入信息返回相应的用户                            |
| `UserBlService.addUser`    | 语法   | `public ResultMessage addUser(UserVO user)` |
|                       | 前置条件 | 正在进行用户管理                                 |
|                       | 后置条件 | 添加一个用户，更新用户列表                            |
| `UserBlService/UserOperate.editUser`   | 语法   | `public ResultMessage editUser(UserVO user)` |
|                       | 前置条件 | 正在进行用户管理                                 |
|                       | 后置条件 | 编辑一个用户，更新用户列表                            |
...
| ---------------------------------------- | ------------------ |
| 服务名                                      | 服务                 |
| `UserDataService.find(String userInfo)` | 根据姓名和id进行查找用户|
| `UserDataService.getList()`            | 取得所有用户的列表         |
...
| ---------------------------------------- | --------------- |
| 服务名                                      | 服务              |
| `LoginDataService.find(String ID,String password)` | 根据用户名和密码取得用户  |
...
| 提供的服务（供接口）           |      |                                          |
| -------------------- | ---- | ---------------------------------------- |
| `MessageBlService.searchMessage` | 语法   | `public Arraylist<MessageVO> searchMessage(UserVO receiver)` |
|                      | 前置条件 | 在各个用户的主界面                                |
|                      | 后置条件 | 根据接收者，返回系统信息                                   |
| `MessageOperate.addMessage` | 语法   | `public Result addMessage(MessageVO message)` |
|                      | 前置条件 | n增加给某一用户的信息                                |
|                      | 后置条件 | 更新持久化数据                                   |
...
| ---------------------------------------- | --------------- |
| 服务名                                      | 服务              |
| `MessageDataService.find(UserPO user)` | 取得该用户的系统信息    |
