...
| 类名        | CBO             | DAC  | NOC  | DIT  |
| --------- | --------------- | ---- | ---- | ---- |
| AccountBl | 11<br/>调用6，被调用5 | 2    | 0    | 0    |
...
| 类名            | CBO             | DAC  | NOC  | DIT  |
| ------------- | --------------- | ---- | ---- | ---- |
| PaymentBillBl | 17<br/>调用9，被调用8 | 4    | 0    | 0    |
...
| 类名            | CBO             | DAC  | NOC  | DIT  |
| ------------- | --------------- | ---- | ---- | ---- |
| ReceiptBillBl | 17<br/>调用9，被调用8 | 4    | 0    | 0    |
...
| 类名         | CBO             | DAC  | NOC  | DIT  |
| ---------- | --------------- | ---- | ---- | ---- |
| CashBillBl | 16<br/>调用8，被调用8 | 4    | 0    | 0    |
...
| 类名        | CBO             | DAC  | NOC  | DIT  |
| --------- | --------------- | ---- | ---- | ---- |
| InitialBl | 12<br/>调用6，被调用6 | 5    | 0    | 0    |
