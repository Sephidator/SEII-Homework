...
public class GoodsData implements GoodsDataService {
    @Override
    public ArrayList<GoodsPO> find(GoodsQueryPO query) throws RemoteException {
        ...
        if (query == null)
            ...
            sql = "SELECT * FROM Goods WHERE (ID='" + query.ID + "' OR name='" + query.name + "' OR goodsSortID='" + query.goodsSortID + "') AND visible=TRUE ";
        else
            sql = "SELECT * FROM Goods WHERE (ID='" + query.ID + "' OR name='" + query.name + "' OR goodsSortID='" + query.goodsSortID + "')";
        try {
    ...
    public synchronized String insert(GoodsPO po) throws RemoteException {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                ID = po.getGoodsSortID() + '-' + "Goods" + String.format("%" + 8 + "d", key);
