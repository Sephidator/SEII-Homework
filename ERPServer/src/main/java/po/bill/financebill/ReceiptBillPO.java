...
public class ReceiptBillPO extends FinanceBillPO {
    ...
    private String clientID; //收款单的客户编号
    ...
    public ReceiptBillPO(String state, Date time, String operatorID, String comment, double total, String clientID, ArrayList<TransItemPO> transList) {
        this.state = state;
        this.time = time;
        type = "收款单";
